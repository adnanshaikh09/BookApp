...
export default function BooksList({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* Header Image */}
      <Image
        source={{ uri: 'https://images.pexels.com/photos/159866/books-book-pages-read-literature-159866.jpeg?cs=srgb&dl=pexels-pixabay-159866.jpg&fm=jpg' }} // Replace with a valid URL
